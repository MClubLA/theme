...
<div class="fnc-share-button"><a id="FancyButton" href="http://fancy.com/fancyit?Category=cars-and-vehicles&Title=<?php urlencode( the_permalink() ); ?>&ItemURL=<?php urlencode( the_title() ) ?>" target="_blank">Fancy</a></div>