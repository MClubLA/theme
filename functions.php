...
function mclub_scripts() {
	...
	wp_register_script( 'jquery-scrolltofixed', get_template_directory_uri() . '/js/jquery-scrolltofixed-min.js', array('jquery') );
	...
	wp_enqueue_script( 'mclub-fixednav', get_template_directory_uri() . '/js/mclub-fixednav.js', array('jquery-scrolltofixed') );
